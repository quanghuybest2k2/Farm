...
const GreenhouseA1 = React.lazy(() =>
  import("./views/DeviceControl/GreenhouseA1")
);
const GreenhouseA2 = React.lazy(() =>
  import("./views/DeviceControl/GreenhouseA2")
);
const GreenhouseA3 = React.lazy(() =>
  import("./views/DeviceControl/GreenhouseA3")
);
const AutoConfig = React.lazy(() => import("./views/AutoConfig/AutoConfig"));
const DetailConfig = React.lazy(() =>
  import("./views/AutoConfig/DetailConfig")
);
const CreateConfig = React.lazy(() =>
  import("./views/AutoConfig/CreateConfig")
);
