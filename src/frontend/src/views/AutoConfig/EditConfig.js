            ...
            <CCardBody>
              ...
              <CForm>
                <CRow className="mb-3">
                  ...
                  <CCol sm={10}>
                    <CFormInput type="text" placeholder="Enter type...." value="Nhiệt độ" />
                  </CCol>
                </CRow>
                <CRow className="mb-3">
                  <CFormLabel className="col-sm-2 col-form-label">Area</CFormLabel>
                  <CCol sm={10}>
                    <CFormInput type="text" placeholder="Enter area...." value="farm-2" />
                  </CCol>
                </CRow>
                <CRow className="mb-3">
                  <CFormLabel className="col-sm-2 col-form-label">Device</CFormLabel>
                  <CCol sm={10}>
                    <CFormSelect size="large" className="mb-3" aria-label="Select device" value="1">
                ...
                <CRow className="mb-3">
                  ...
                  <CCol sm={10}>
                    <CFormSelect size="large" className="mb-3" aria-label="Select status" value="1">
                  ...
                  <CCol sm={5}>
                    <div className="d-flex mt-3 align-items-center">
                      <div className="me-2">
                        ...
                        <CFormInput type="number" placeholder="Enter start value...." value="25" />
                      </div>
                      ...
                      <div className="ms-2">
                        ...
                        <CFormInput type="number" placeholder="Enter end value...." value="30" />
                      </div>
                    </div>
                  </CCol>
                </CRow>
                ...
                <CRow className="mt-4">
                  ...
                  <CCol sm={10}>
                    <CFormSelect size="large" className="mb-3" aria-label="Select active" value="1">
